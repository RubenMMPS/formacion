...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.rich-text', 'blocks.gallery', 'blocks.links']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    materials: Schema.Attribute.Component<'event.material', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    teachers: Schema.Attribute.Relation<'manyToMany', 'api::teacher.teacher'>;
    themes: Schema.Attribute.Component<'event.theme', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
